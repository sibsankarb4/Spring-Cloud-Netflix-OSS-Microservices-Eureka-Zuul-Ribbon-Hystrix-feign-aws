package com.sibsankar.spring.cloud.aws;
...
import com.sibsankar.spring.cloud.aws.s3.SpringCloudS3Service;

@Configuration
@EnableAutoConfiguration
@ComponentScan("com.sibsankar.spring.cloud.aws.s3")
public class InstanceProfileAwsApplication {
    ...
    private static void setupResources() {
        bucketName = "sibsankar-test-" + UUID.randomUUID()
            .toString();
        try {
